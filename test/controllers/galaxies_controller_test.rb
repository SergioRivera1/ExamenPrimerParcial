...
class GalaxiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create galaxy" do
    assert_difference('Galaxy.count') do
      post galaxies_url, params: { galaxy: { estrellas: @galaxy.estrellas, name: @galaxy.name, planetas: @galaxy.planetas } }
    end
  ...
  test "should update galaxy" do
    patch galaxy_url(@galaxy), params: { galaxy: { estrellas: @galaxy.estrellas, name: @galaxy.name, planetas: @galaxy.planetas } }
