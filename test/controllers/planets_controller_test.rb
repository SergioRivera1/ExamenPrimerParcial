...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { kmlongitud: @planet.kmlongitud, name: @planet.name, ubication: @planet.ubication } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { kmlongitud: @planet.kmlongitud, name: @planet.name, ubication: @planet.ubication } }
